...
#define SERVO_CMD_NEUTRAL_DEG 45
#define SERVO_CMD_MIN_DEG 0
#define SERVO_CMD_MAX_DEG 180
#define SERVO_CMD_DEFAULT_THEORETICAL_MIN_DEG 0
#define SERVO_CMD_DEFAULT_THEORETICAL_MAX_DEG 90
#define SERVO_CMD_DEFAULT_LIMIT_MIN_DEG 15
#define SERVO_CMD_DEFAULT_LIMIT_MAX_DEG 75
