...
#define CONTROLLER_DEFAULT_SPEED_DEADBAND_MM_S 75
#define CONTROLLER_DEFAULT_LOST_BALL_DELAY_MS 3000
#define CONTROLLER_DEFAULT_LOST_BALL_ITER 3
#define CONTROLLER_DEFAULT_MAX_CONTROL_SPEED_MM_S 1000
#define CONTROLLER_DEFAULT_PERIOD_MS 30
#define CONTROLLER_DEFAULT_STABLE_TIME_MS 500
#define CONTROLLER_DEFAULT_IDLE_EXIT_PERCENT 200
...
bool set_controller_stable_time_ms(uint32_t stable_time_ms);
